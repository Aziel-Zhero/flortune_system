...
const SIDEBAR_WIDTH_ICON = "3.5rem" // Increased width for better icon visibility
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[min(18rem,calc(100vw-1rem))] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
  ...
  return (
    <Tooltip>
      <TooltipTrigger
        ...
        className={cn(
          "absolute inset-y-0 z-20 w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
