        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="grid gap-1.5 leading-none">
            <label htmlFor="terms" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
              Eu aceito os{" "}
              <Link href="#" className="underline text-primary" onClick={(e) => e.preventDefault()}>Termos de Serviço</Link> e a{" "}
              <Link href="#" className="underline text-primary" onClick={(e) => e.preventDefault()}>Política de Privacidade</Link>.
            </label>
