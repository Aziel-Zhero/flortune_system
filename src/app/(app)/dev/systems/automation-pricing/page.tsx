...
import { Briefcase, DollarSign, Repeat, AlertCircle, BarChartHorizontalBig, HelpCircle, ArrowLeft } from "lucide-react";
    ...
    <Dialog open={isHelpOpen} onOpenChange={setIsHelpOpen}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Card className="shadow-lg">
            <CardHeader>
                ...
                <CardDescription>Insira os ganhos estimados para o cliente e seus custos para calcular a precificação.</CardDescription>
            </CardHeader>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Precificar com base no ROI (Retorno sobre o Investimento) alinha seu preço ao valor que você gera.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4 text-sm">
          <p>Esta calculadora utiliza um modelo comum para precificar automações e serviços contínuos, focando em uma taxa de setup inicial e uma mensalidade para manutenção.</p>
          <div className="p-3 bg-muted rounded-md font-mono text-xs overflow-x-auto">
            <p className="font-bold">Taxa de Setup =</p>
            <p className="ml-2">Ganho Anual do Cliente × 0.25</p>
            <br />
            <p className="font-bold">Mensalidade =</p>
            <p className="ml-2">(Seus Custos Mensais + Custo Suporte) × 2</p>
             <br />
            <p className="font-bold">Payback (meses) =</p>
            <p className="ml-2">Taxa de Setup / ( (Ganho Anual / 12) - Mensalidade )</p>
          </div>
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            <li>A **Taxa de Setup** é uma porcentagem (aqui, 25%) do valor que o cliente economizará ou ganhará em um ano. É a sua recompensa por criar a solução.</li>
            <li>A **Mensalidade** garante que seus custos operacionais sejam cobertos com uma margem de lucro saudável (aqui, 100% de margem sobre os custos).</li>
             <li>O **Payback** mostra ao cliente em quantos meses o investimento na sua solução "se paga" com a economia/ganho gerado. Um payback baixo é um forte argumento de venda.</li>
          </ul>
        </div>
        <DialogFooter>
