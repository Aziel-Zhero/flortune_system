      ...
      {noTransactionsAtAll ? (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="md:col-span-2 lg:col-span-3 shadow-sm">
                ...
                <CardContent className="h-96"> {/* Garantir que o CardContent tenha altura */}
                    {monthlyEvolution.length > 0 && monthlyEvolution.some(d => d.Receitas > 0 || d.Despesas > 0) ? (
                        <ChartContainer config={realDataChartConfig} className="min-h-[300px] w-full h-full"> {/* Adicionado h-full */}
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart
                                    accessibilityLayer
                                    data={monthlyEvolution}
                                    margin={{
                                        top: 20, // Aumentado para a legenda
                                        right: 30, 
                                        left: 20, 
                                        bottom: 70, // Aumentado para labels X rotacionados
                                    }}
                                >
                                    ...
                                    <XAxis
                                        ...
                                        tickLine={false}
                                        axisLine={false}
                                        tickMargin={10} // Espaço entre tick e label
                                        interval={0}
                                        angle={-45}
                                        textAnchor="end"
                                        height={80} // Altura para labels rotacionados
                                        dy={10}    // Deslocamento vertical do label
                                        tick={{ fontSize: 10 }}
                                    />
                                    <YAxis
                                        ...
                                        dx={-5}    // Deslocamento horizontal do label
                                        width={70} // Largura explícita para o eixo Y
                                    />
                                    ...
                                    <Line type="monotone" dataKey="Receitas" stroke="var(--color-Receitas)" strokeWidth={2} dot={{ fill: "var(--color-Receitas)", r: 3 }} activeDot={{ r: 5 }} name="Receitas" />
                                    <Line type="monotone" dataKey="Despesas" stroke="var(--color-Despesas)" strokeWidth={2} dot={{ fill: "var(--color-Despesas)", r: 3 }} activeDot={{ r: 5 }} name="Despesas" />
                                </LineChart>
                            </ResponsiveContainer>
                        </ChartContainer>
