...
-- 1. Função Auxiliar para verificar se um usuário é admin
-- Definida no início para que possa ser usada nas políticas abaixo.
...
-- 2. Definição da tabela de Perfis
...
-- ---------------------------------------------------------------------------------
-- SEÇÃO DE ADMINISTRAÇÃO E LEADS (INTEGRAÇÃO E POLÍTICAS)
-- ---------------------------------------------------------------------------------
...
-- 3. Políticas de Administrador para public.profiles
