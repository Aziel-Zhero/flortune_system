...
export const NAV_LINKS_CONFIG = [
  ...
  { href: "/dev/scrum", label: "Scrum Planner", icon: "GanttChartSquare" as const, type: "link" as const },
  { href: "/dev/scrum-analytics", label: "Scrum Analytics", icon: "PieChart" as const, type: "link" as const },
