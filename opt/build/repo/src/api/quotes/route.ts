...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Também tratamos o caso onde a API retorna um array para uma cotação específica.
    const dataArray = Object.values(responseData).map(value => Array.isArray(value) ? value[0] : value);
