...
if (!nextAuthSecret) {
  ...
  if (process.env.NODE_ENV === 'production') { 
    // Forcing a build error if this critical variable is missing during build time in production.
    // This might be too aggressive if Netlify sets it later, but good for now.
