...
export default function DevKanbanPage() {
  ...
  const handleAddColumn = () => {
    ...
    const newColumnName = `Nova Coluna ${Object.keys(columns).length - 2}`;
    setColumns({
      ...columns,
      [newColumnId]: { name: newColumnName, tasks: [] }
    });
        ...
        <DragDropContext onDragEnd={onDragEnd}>
          <div className="flex-1 flex gap-4 overflow-x-auto pb-4">
            ...
            <div className="w-72 flex-shrink-0">
               ...
               <Button variant="outline" className="w-full h-12 mt-2" onClick={handleAddColumn}>
                  <PlusCircle className="h-5 w-5 mr-2"/>
