...
import { Calculator, DollarSign, ClockIcon, Percent, AlertCircle, BarChartHorizontalBig, HelpCircle, ArrowLeft } from "lucide-react";
    ...
    <Dialog open={isHelpOpen} onOpenChange={setIsHelpOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Entenda como o preço do seu projeto é calculado.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4 text-sm">
          <p>A calculadora usa uma fórmula de custo-mais (cost-plus pricing) para determinar o preço final, garantindo que todos os seus custos sejam cobertos e sua margem de lucro seja aplicada.</p>
          <div className="p-3 bg-muted rounded-md font-mono text-xs overflow-x-auto">
            <p className="font-bold">Custo Base =</p>
            <p className="ml-2">Valor/Hora × Horas Estimadas</p>
            <br />
            <p className="font-bold">Custo com Complexidade =</p>
            <p className="ml-2">Custo Base × Fator de Complexidade</p>
            <br />
            <p className="font-bold">Preço Final =</p>
            <p className="ml-2">(Custo com Complexidade + Taxas Adicionais) × (1 + (Margem de Lucro / 100))</p>
          </div>
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            <li>O **Fator de Complexidade** (1.0, 1.25 ou 1.5) ajusta o preço para projetos que exigem mais pesquisa, tecnologia nova ou integrações complexas.</li>
            <li>As **Taxas Adicionais** cobrem custos fixos que não são baseados em horas, como licenças de software ou compra de assets.</li>
          </ul>
        </div>
        <DialogFooter>
