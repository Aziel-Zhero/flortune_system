...
import { FinancialGoalForm } from "./goal-form"; // Importar o formulário
...
export default function GoalsPage() {
  ...
  const handleGoalCreated = () => {
    ...
    fetchGoalsData(); // Re-fetch goals to update the list
  };
        ...
        actions={
          <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
            ...
            <DialogContent className="sm:max-w-[625px]">
              ...
              <FinancialGoalForm onGoalCreated={handleGoalCreated} />
            </DialogContent>
          </Dialog>
        }
      />
