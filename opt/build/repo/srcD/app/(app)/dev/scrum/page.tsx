...
export default function DevScrumPage() {
  ...
  return (
    <Dialog open={isSprintModalOpen || isMemberModalOpen} onOpenChange={(open) => { if (!open) { setIsSprintModalOpen(false); setIsMemberModalOpen(false); } }}>
      ...
      {isSprintModalOpen && (
        <DialogContent>
            ...
            <form onSubmit={handleSprintSubmit(onNewSprintSubmit)} className="space-y-4">
                ...
                <DialogFooter><DialogClose asChild><Button type="button" variant="outline" onClick={() => setIsSprintModalOpen(false)}>Cancelar</Button></DialogClose><Button type="submit">Iniciar Sprint</Button></DialogFooter>
            </form>
        </DialogContent>
      )}
      ...
      {isMemberModalOpen && (
        <DialogContent className="sm:max-w-md">
            ...
            <form onSubmit={handleSubmit(onAddMember)} className="space-y-4 py-2">
                ...
                <DialogFooter className="pt-2"><DialogClose asChild><Button type="button" variant="outline" onClick={() => setIsMemberModalOpen(false)}>Cancelar</Button></DialogClose><Button type="submit">Adicionar ao Time</Button></DialogFooter>
            </form>
        </DialogContent>
      )}
    </Dialog>
