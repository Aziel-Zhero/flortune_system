...
import { Share2, PlusCircle, Trash2, UserPlus, Send, Settings, Package, Users } from "lucide-react";
  ...
  return (
    <>
      <PageHeader
        ...
        actions={<DialogTrigger asChild><Button onClick={() => setIsModuleModalOpen(true)}><PlusCircle className="mr-2 h-4 w-4"/>Criar Módulo</Button></DialogTrigger>}
      />
